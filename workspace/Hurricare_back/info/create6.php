...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" ng-controller="CreateTreatmentCtrl">
    <div class="row">
        <ol class="breadcrumb">
    ...
    <div class="row" style="margin-bottom: 2em;">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="progress">
                    <div class="progress-bar progress-bar-info progress-bar-striped active" style="width: 83%;">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading"><span class="glyphicon glyphicon-list-alt"></span>Add Treatment Information</div>
                    ...
                    <div class="col-md-12">
                        <form enctype="multipart/form-data">
                            ...
                            <div style="margin-top: 1em;margin-bottom: 1em;">
                                ...
                                <div class="pure">Insert Treat images.</div>
                            ...
                            <div style="margin-top: 1em;margin-bottom: 1em;">
                                ...
                                <div class="pure">Insert Treat videos.</div>
                            ...
                            <div style="margin-top: 2em;">
                                ...
                                <button type="submit" class="btn btn-primary pull-right"
                                        style="margin-right: 1em;" ng-click="create_unit(text,attachments,videos)"> Finish
                                </button>
                            </div>
                    </div>
                    </form>
